      ...
      screens: [
        {
          ...
          alt: "여섯 사람이 있는 그룹 대화 화면. 왼쪽 목록에 대화 여섯 개가 어제·8월 5일처럼 날짜와 함께 있고, 같은 사람이 이어 보낸 메시지는 이름과 프로필을 한 번만 쓴다. 오른쪽 위에 초대 링크 복사 단추가 있고, 내가 보낸 메시지 옆에 전달 완료 표시가 붙어 있다",
          caption:
            "그룹 대화 — 전달 완료는 DB 커밋이 끝난 뒤에 붙는다. 화면에 떴다는 뜻이 아니다. 초대 링크로 상대를 부르면 두 사람 사이에 실제로 메시지가 오간다",
        },
        {
          width: 1280,
          height: 800,
