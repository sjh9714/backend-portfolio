export const profile = {
  ...
  lead: "좌석 예약·사용량 과금·실시간 전달에서 서버가 에러 없이 조용히 실패하는 지점을 재현하고 막아 왔습니다. 측정하지 못한 것은 측정하지 못했다고 적었습니다.",
  /** 각 항목은 해당 문제 해결로 바로 연결된다 */
  proofChips: [
    ...
    { text: "중복 과금 0건", href: "/projects/ai-usage-billing-gateway#idempotency" },
  ],
